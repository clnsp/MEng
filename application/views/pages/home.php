<div class="row"><div class="col-xs-12 col-sm-6"><h2 class="time"><small class="current-date pull-left"><?php echo $cDate ?></small></h2></div><div class="col-xs-12 col-sm-6"><h2 class="time"><small class="current-time visible-xs pull-left"><?php echo $cTimespan ?></small><small class="current-time hidden-xs pull-right"><?php echo $cTimespan ?></small></h2></div></div>
<!--HEADING-->
